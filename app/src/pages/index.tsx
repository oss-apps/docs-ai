    ...
    <>
      ...
      <main className="mx-auto  max-w-6xl pb-32 px-4 lg:px-0">
        ...
        <section className="mt-32 px-4 lg:px-0">
          ...
          <div className="w-full flex mt-20 justify-between border-b pb-10 flex-wrap">
            <div>
              <p className="font-semibold text-2xl">Customer support agent</p>
              <div className="flex gap-2 items-start mt-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-green-500 mt-1.5">
          ...
          <div className="w-full flex mt-32 justify-between border-b pb-10 flex-wrap">
            <div>
