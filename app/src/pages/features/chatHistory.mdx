...
### Clear conversations
You can  use the `clear` to clear the entire chat history or use `delete` option to delete selected conversations. Clearning 
conversations will take a toll on dashboard data.
