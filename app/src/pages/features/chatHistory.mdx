...
### User Identification
If you enable user email prompts and a user enters their email address, a user check icon and their user ID will appear below the summary.
...
Conversations can be filtered based on 
  - Date and Time Range
  - Feedback (Postive, Negative, All, No Filter)
  - Sentiment (Positive, Negative, All, Neutral)
