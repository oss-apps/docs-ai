...
Currently Websites, Plain Text and files can be uploaded to the DocsAI. You can re-sync and delete documents. Send us an email at hey@docsai.app or let us know in the [Feature Requests](https://docsai.canny.io/featrue-requests) if you want to request a specific document type.
